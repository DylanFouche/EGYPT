...
class Household():
    ...
    def competency_increase(self):
        """ Increase household competency by annual competency increase percentage """
        new_competency = self.competency + (self.competency * (self.settlement.model.annual_competency_increase/100))
        self.competency = new_competency if new_competency < 1 else 1
...
class EgyptModel(Model):
    ...
    def __init__(self, w, h,
        ...
        self.annual_competency_increase = annual_competency_increase
        self.ticks = 0
